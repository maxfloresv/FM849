...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\linewidth]{days/03/image/hist_flipper.png}
...
\begin{columns}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.65\linewidth]{days/03/image/heatmap.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.75\linewidth]{days/03/image/heatmap_plt.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{days/03/image/correlacion_seaborn.png}
