...
\begin{figure}[H]
\centering
\includegraphics[width=0.7\linewidth]{days/03/image/plt_line.png}
\caption{Grafico de línea en matplotlib.}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.7\linewidth]{days/03/image/plt_scatter.png}
\caption{Grafico de dispersión en matplotlib..}
\end{figure}
...
\begin{minted}{python}
import numpy as np
temperatura_santiago = np.random.randn(1000) + 25 
...
\begin{figure}[H]
\centering
\includegraphics[width=0.7\linewidth]{days/03/image/plt_hist.png}
...
\begin{minted}{python}
temperatura_santiago = np.random.randn(100)
...
\begin{figure}[H]
\centering
\includegraphics[width=0.7\linewidth]{days/03/image/plt_boxplot.png}
