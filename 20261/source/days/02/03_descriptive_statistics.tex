...
\begin{document}
    ...
    \begin{frame}{Motivación}
        La estadística nos ayuda a:

        \begin{itemize}
            \item \textbf{Describir} el comportamiento de fenómenos complejos utilizando conceptos sencillos (ejemplo: la media).
            \pause
            \item \textbf{Capturar} aspectos esenciales de los datos como su estructura y saber que tan incierto es el comportamiento generado en estos.
            \pause
            \item Tomar \textbf{decisiones} mediante el análisis de datos, identificando tendencias y variabilidad en estos.
            \pause
            \item \textbf{Predecir} resultados futuros a partir de datos pasados, sirviendo como base para modelos de aprendizaje automático.
            \pause
        \end{itemize}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.3\linewidth]{days/02/images/pure.png}
        \caption{Resultados del experimento PURE.}
    ...
    \textbf{Pregunta:} Existe causalidad entre el consumo de grasas y la tasa de muerte ?
    \pause
    \newline
    \textbf{No necesariamente, pues correlacción no implica causalidad.} (Ahondaremos más en esto en las siguientes slides)
    ...
    El estudio \textbf{PURE} permitió:
    \pause

    \begin{itemize}
        \item Resumir un gran dataset en este gráfico con solo con 10 valores. %es imposible ver los datos uno a uno 
        \pause
        \item Detectar \textbf{incertidumbre} en los datos.
        \pause
    \end{itemize}

    Adicionalmente, la Estadística proporciona herramientas que ayudan a decidir que tan probable es que este experimento ocurra de forma aleatoria. 

    \end{frame}

    \begin{frame}[fragile]
    \frametitle{Un Resumen de los Principios de la Estadística}
    ...
    \vspace{5mm}
    En esta clase hablaremos un poco sobre estadística descriptiva. En la siguiente clase ahondaremos en la visualización de datos. 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    \begin{tikzpicture}
        ...
        \end{axis}
        \end{tikzpicture}
        \caption{Ejemplo de datos outliers.}
    \end{figure}
    ...
    %Existen otras métricas mas robustas ? 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    \begin{frame}[fragile]
    \frametitle{Comparación entre media, mediana y moda}
    
    Es interesante ver como cambia la distribución de los datos para diferentes casos.

    \vspace{3mm}

    \begin{figure}
        \centering
        \includegraphics[width=0.55\linewidth]{days/02/images/mean_mode_median.png}
        \caption{Diferentes tipos de distribuciones.}
        %\label{fig:placeholder}
    \end{figure}
    ...
    La media puede ser generalizada con el concepto de percentil. Los \textbf{percentiles} dividen los datos ordenados en 100 partes iguales.
    
    \pause
    %\vspace{3mm}

    \begin{itemize}
        \item El percentil 50 corresponde a la \textbf{mediana}.
        \pause
        \item El percentil 25 y 75 definen el \textbf{rango intercuartílico}.
        \pause
        \item Los percentiles 25, 50 y 75 dividen los valores en 4 partes iguales y son descritos mediante graficos de boxplots.
    \end{itemize}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.4\linewidth]{days/02/images/boxplot.png}
        %\caption{Diferentes tipos de distribuciones.}
        %\label{fig:placeholder}
    \end{figure}
    ...
    Una métrica bastante importante es la correlación líneal $r(x,y)$, que estima la relación entre dos variables (covarianza) independiente de su mágnitud.
