...
\begin{document}
    \classtitle{0}{Introducción y reglas del curso}{5 de enero de 2026}
    ...
    \begin{frame}{¿De qué se trata el curso?}
        En problemas de ciencias de la computación clasicos, consideramos un \emph{input} y un programa o algoritmo que genera un \emph{output}.

        \begin{figure}[H]
            \centering
            \includegraphics[width=0.8\linewidth]{days/01/images/cs_ml1.png}
        \end{figure}
    \end{frame}

    
    \begin{frame}{¿De qué se trata el curso?}
        Hay problemas donde existen tantas combinaciones, que es imposible encontrar un algoritmo que lo resuelva en un tiempo razonable...

        \begin{figure}[H]
            \centering
            \includegraphics[width=0.8\linewidth]{days/01/images/cs_ml2.png}
        \end{figure}
    \end{frame}
    ...
    \begin{frame}{¿De qué se trata el curso?}
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[width=0.7\linewidth]{days/01/images/cs_ml3.png}
        \end{figure}
    \end{frame}
    ...
    \begin{frame}{¿De qué se trata el curso?}
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[width=\linewidth]{days/01/images/cs_ml4.png}
        \end{figure}
    \end{frame}
    ...
    \begin{frame}{Evaluaciones}
        ...
        \pause
        La nota final ($\mathrm{NF}$) del curso se calcula, si tanto el promedio de tareas como la coevaluación son $\ge 4.0$, como:
        \[
    ...
    \begin{frame}{Bonificación por participación}
        ...
        \pause
        En esta versión del curso, implementaremos una trivia después de cada clase, usando la plataforma \href{https://www.mentimeter.com/es-ES}{Mentimeter}. Esta trivia tiene un podio, y quienes logren quedar en él, obtendrán las siguientes bonificaciones, aplicables en cualquier tarea:
        \begin{itemize}
            \item 1.\textsuperscript{er} lugar: $\mathbf{3}$ \textbf{décimas}.
            \item 2.\textsuperscript{do} lugar: $\mathbf{2}$ \textbf{décimas}.
            \item 3.\textsuperscript{er} lugar: $\mathbf{1}$ \textbf{décima}.
        \end{itemize}
    ...
    \begin{frame}{Canales de comunicación}
        ...
        \pause
        Si pierden el acceso a alguna plataforma, les dejamos nuestros correos en esta \textit{slide}:
        \begin{center}
        ...
        \begin{alertblock}{Regla de oro}
            Escríbannos en horarios razonables (9:00 -- 19:00). Pueden programar correos si están trabajando fuera de estos horarios. Asegúrense de que su duda no esté respondida.
        \end{alertblock}
    \end{frame}
\end{document}