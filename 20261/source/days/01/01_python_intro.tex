...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    \begin{frame}[fragile]{Pregunta 1 Menti}
    
    Que retornará el siguiente codigo?
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.2\linewidth]{days/01/images/mentimeter_qr.png}
        \caption{Codigo QR para contestar.}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    \begin{frame}[fragile]{Pregunta 2 Menti}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    \begin{frame}[fragile]{Pregunta 3 Menti}
    
    Que print se genera con el siguiente codigo?
    ...
    \begin{frame}[fragile]{Pregunta 4 Menti}
...
%    \begin{frame}[fragile]{Pregunta 5 Menti}
%    
%    Que print se genera con el siguiente codigo?
%
%    \begin{minted}{python}
...
%        >>>   number = 3
%
%        >>> if number < 10 and number2 < 10:
%        >>>   print("number y number2 son menores que 10 !")
%    \end{minted}
%
%    \begin{figure}
%        \centering
%        \includegraphics[width=0.4\linewidth]{days/01/images/mentimeter_qr.png}
%        \caption{Codigo QR para contestar.}
%        \label{fig:placeholder}
%    \end{figure}
%    
