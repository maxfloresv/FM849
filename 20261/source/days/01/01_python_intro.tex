...
\begin{frame}[fragile]
\frametitle{Condicionales e Indentacion}
Python tiene condicionales logicos para \textbf{controlar el flujo de ejecución del codigo}. Para entender los condicionales necesitamos introducir el concepto de \textbf{indentacion}:
