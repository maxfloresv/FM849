...
Supongamos que tenemos una tabla con datos de mensajes (Spam y no Spam).
Calculamos dos features (características) para cada mensaje.
...
\hline
\textbf{Oración} & $x_1$ & $x_2$ & \textbf{Etiqueta} \\
\hline
...
\onslide<2->{
\begin{itemize}
    \item $x_1$: Número de veces que ocurre [oferta, pago, dinero].
    \item $x_2$: Número de veces que ocurre [hijo, hija, amigo].
\end{itemize}
}
